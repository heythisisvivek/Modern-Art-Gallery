...
<body>
    <!-- Header -->
      <div class="row" style='background-color: #343a40; color: #FFF; border-bottom: 1px solid grey'>
        <div class="col-md-3" style="text-align: center">
        <i class="fas fa fa-phone-alt"></i> +919876.....
        </div>
        <div class="col-md-6">
        </div>
        <div class="col-md-3">
          <ul type="none">
            <li style="display: inline-block; margin: 0 5px; font-size: 20px"><a href="" class="fab fa-facebook"></a></li>
            <li style="display: inline-block; margin: 0 5px; font-size: 20px"><a href="" class="fab fa-twitter"></a></li>
            <li style="display: inline-block; margin: 0 5px; font-size: 20px"><a href="" class="fab fa-dribbble"></a></li>
            <li style="display: inline-block; margin: 0 5px; font-size: 20px"><a href="" class="fab fa-linkedin"></a></li>
          </ul>
        </div>
      </div>
