  <!-- Site footer -->
    ...
    <div class="row">
        ...
        <ul class="footer-links">
            ...
            <li><a href="#">Water Painting</a></li>
            <li><a href="#">Artices Special</a></li>
            <li><a href="#">Digital Painting</a></li>
            <li><a href="#">Classical Painting</a></li>
        </ul>
        </div>
    ...
    <div class="row">
        ...
        <a href="http://localhost/Art%20Gallery/">Art Gallery</a>.
        </p>
        </div>
